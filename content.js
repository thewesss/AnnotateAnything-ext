(function() {
    ...
    // Function to draw all stored annotations onto a given canvas context
    ...
    function createToolbar() {
                ...
                <div class="${PREFIX}toolbar-row">
                    <div class="${PREFIX}tool-group">
                        ...
                        <button data-tool="eraser" class="${PREFIX}tool-button" title="Eraser">
                            <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24"><path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="m7 21l-4.3-4.3c-1-1-1-2.5 0-3.4l9.6-9.6c1-1 2.5-1 3.4 0l5.6 5.6c1 1 1 2.5 0 3.4L13 21m9 0H7M5 11l9 9"/></svg>
                        </button>
                    </div>
        ...
        // ... (rest of the listeners from previous version, ensure they are here) ...
    ...
    // This function will now FETCH the content.css and inject it.
    async function addStyles() {
        try {
            ...
            console.error('Failed to load or inject content.css:', error);
            // Consider more robust error handling or user notification here
        }
    }
    ...
    // Get session ID from browser.webfuseSession API (UPDATED API)
    async function getSessionId() {
        try {
            const sessionInfo = await browser.webfuseSession.getSessionInfo(); // Changed to browser.webfuseSession
    ...
    // These functions are no longer needed for style injection.
    ...
    // --- Toolbar and Canvas Event Listeners ---

    // --- Initialization ---
    function init() {
        addStyles(); // This now fetches and injects the CSS
        createToolbar();
        createCanvas();
